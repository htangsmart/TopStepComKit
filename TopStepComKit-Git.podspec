...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TopStepComKit-Git.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rd@hetangsmart.com/TopStepComKit-Git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rd@hetangsmart.com' => 'tengzhang@topstep-tech.com' }
  s.source           = { :git => 'https://github.com/rd@hetangsmart.com/TopStepComKit-Git.git', :tag => s.version.to_s }
