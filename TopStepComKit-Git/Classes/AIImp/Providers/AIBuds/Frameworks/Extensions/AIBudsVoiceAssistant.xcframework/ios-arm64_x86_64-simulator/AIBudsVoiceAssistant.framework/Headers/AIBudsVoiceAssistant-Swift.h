...
#ifndef AIBUDSVOICEASSISTANT_SWIFT_H
#define AIBUDSVOICEASSISTANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIBudsVoiceAssistant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Unknown error
  AIBudsVoiceAssistantSdkErrorCodeUnknown = -1,
...
@interface AIBudsVoiceAssistantSDK : NSObject
...
@interface AIBudsVoiceAssistantSDK (SWIFT_EXTENSION(AIBudsVoiceAssistant))
/// The error domain used for VoiceAssistant SDK errors
...
/// The error key used for VoiceAssistant SDK errors
...
/// The error domain used for MZEncrypt SDK errors
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull MZEncryptSdkErrorDomain;)
+ (NSString * _Nonnull)MZEncryptSdkErrorDomain SWIFT_WARN_UNUSED_RESULT;
@end
