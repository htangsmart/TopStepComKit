...
#ifndef AIBUDSAIDASHBOARD_SWIFT_H
#define AIBUDSAIDASHBOARD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIBudsAIDashboard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
/// The main entry point for the AIDashboardSDK.
...
SWIFT_CLASS_NAMED("AIDashboardSDK")
@interface AIBudsAIDashboardSDK : NSObject
/// Indicates whether the SDK is currently running
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL isRunning;)
+ (BOOL)isRunning SWIFT_WARN_UNUSED_RESULT;
/// Private initializer to enforce singleton pattern
/// note:
/// This prevents creating multiple instances of AIDashboardSDK
...
///
+ (BOOL)startWithPort:(NSUInteger)port SWIFT_WARN_UNUSED_RESULT;
