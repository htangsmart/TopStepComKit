...
#ifndef AIBUDSXLFACILITY_SWIFT_H
#define AIBUDSXLFACILITY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIBudsXLFacility",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// note:
/// This prevents creating multiple instances of XLFacilitySDK
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// The shared singleton instance of XLFacilitySDK
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AIBudsXLFacilitySDK * _Nonnull shared;)
...
/// Queries the database for log messages within the specified timestamp range.
/// \param startTimestamp The start timestamp of the query range.
///
/// \param endTimestamp The end timestamp of the query range.
///
/// \param completion The completion handler that is called when the query operation is completed.
/// <ul>
///   <li>
///     logs: The array of log messages, or nil if the query operation failed.
///   </li>
///   <li>
///     error: The error object, or nil if the query operation was successful.
///     <ul>
///       <li>
///         Each log message is a dictionary with keys “timestamp”, “tag”, “level”, and “message”.
///       </li>
///     </ul>
///   </li>
/// </ul>
///
- (void)queryLogsFrom:(NSDate * _Nullable)startTimestamp to:(NSDate * _Nullable)endTimestamp completion:(void (^ _Nullable)(NSArray<NSDictionary<NSString *, id> *> * _Nullable, NSError * _Nullable))completion;
