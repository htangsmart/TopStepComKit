...
/**
 * @brief AI Translate provider protocol
 * @chinese AI 翻译接口协议
 *
 * @discussion
 ...
 */
@protocol TSAITranslateProvider <NSObject>

/**
 * @brief Whether text translation is supported
 * @chinese 是否支持文本翻译
 *
 * @return
 * EN: YES when text translation is supported
 * CN: 支持文本翻译时返回 YES
 */
