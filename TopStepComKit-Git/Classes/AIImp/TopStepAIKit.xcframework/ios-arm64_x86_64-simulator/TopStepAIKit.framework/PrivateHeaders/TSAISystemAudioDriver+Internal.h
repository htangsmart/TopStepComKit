 ...
 * @param errorHandler EN: Runtime audio-path error callback. CN: 音频链路运行时错误回调。userInfo.audioFailureScope 为 output 时仅影响播放，input 表示输入失效。
...
/** @brief Interrupt current output @chinese 仅中断当前输出，不停止仍有效的系统采集 */
