 ...
 *
 * @discussion
 * [EN]: TopStepPersimwearKit implementation of TSAIDailyGuidanceInterface.
 * This class is created by the SDK protocol factory and should be accessed through TopStepComKit.aiDailyGuidance.
 *
 * [CN]: TopStepPersimwearKit 对 TSAIDailyGuidanceInterface 的实现。
 * 该类由SDK协议工厂创建，业务侧应通过 TopStepComKit.aiDailyGuidance 访问。
 */
@interface TSFwAIDailyGuidance : TSFwKitBase <TSAIDailyGuidanceInterface>
