//
//  TSDailyActivityGoalsModel+Fit.h
//  TopStepFitKit
//
 ...
 *            - 卡路里：小卡(cal) <-> 千卡(kcal)
 */
@interface TSDailyActivityGoalsModel (Fit)
 ...
 */
+ (nullable TSDailyActivityGoalsModel *)goalsModelFromFitCloudDailyGoalObject:(nullable FitCloudDailyGoalObject *)fitGoal;
 ...
 */
+ (NSArray<TSDailyActivityGoalsModel *> *)goalsModelsFromFitCloudDailyGoalObjects:(nullable NSArray<FitCloudDailyGoalObject *> *)fitGoals;
