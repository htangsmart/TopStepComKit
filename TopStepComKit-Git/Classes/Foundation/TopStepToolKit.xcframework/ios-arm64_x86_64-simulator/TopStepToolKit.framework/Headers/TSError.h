...
/// 创建错误码错误
#define TSERROR_COM_CODE(Domain, Code) TSERROR_MESSAGE(Domain,Code,[TSErrorMsgDefines errorMsgForCode:Code])
...
#define TS_MESSAGE_NOT_SUPPORT @"暂不支持该功能"
...
/// AI错误域 (AI error domain)
FOUNDATION_EXPORT NSString *const kTSErrorDomainAIName;
...
/// 设备媒体文件错误域 (Device media file error domain)
...
/// 祈祷错误域 (Prayer error domain)
FOUNDATION_EXPORT NSString *const kTSErrorDomainPrayerName;
...
/// 测量错误域 (Measure error domain)
FOUNDATION_EXPORT NSString *const kTSErrorDomainMeasureName;
