...
/**
 * @brief peripheral storage information model
 * @chinese 外设存储信息模型
 *
 * @discussion
 * EN: This model represents the storage information of the peripheral,
 *     including total storage space and available storage space.
 * CN: 此模型表示外设的存储信息，包括总存储空间和可用存储空间。
 */

@interface TSStorageInfoMode : TSKitBaseModel
 ...
 *
 * @discussion
 * [EN]: Total storage capacity of the peripheral in bytes.
 ...
 *
 * @discussion
 * [EN]: Available storage space on the peripheral in bytes.
