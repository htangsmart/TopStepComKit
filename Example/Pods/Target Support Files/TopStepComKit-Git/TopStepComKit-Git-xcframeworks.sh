...
install_xcframework "${PODS_ROOT}/TopStepComKit-Git/TopStepComKit-Git/Classes/FitCoreImp/ABParTool.xcframework" "TopStepComKit-Git/FitCoreImp" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
