...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TopStepComKit-Git/FitCoreImpSupport/ABParTool.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TopStepComKit-Git/FitCoreImpSupport/RTKLEFoundation.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TopStepComKit-Git/FitCoreImpSupport/RTKOTASDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TopStepComKit-Git/FitCoreImpSupport/RTKLocalPlaybackSDK.framework"
