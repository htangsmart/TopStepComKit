...
@interface TopStepContactModel (Npk)
 ...
 * @chinese 将 TSMetaContactItem 转为 TopStepContactModel
 */
+ (nullable TopStepContactModel *)modelWithTSMetaItem:(nullable TSMetaContactItem *)item;

/**
 * @brief Convert array of TopStepContactModel to TSMetaContactList
 * @chinese 将 TopStepContactModel 数组转为 TSMetaContactList
 */
+ (nullable TSMetaContactList *)tsMetaListWithModels:(nullable NSArray<TopStepContactModel *> *)models;

/**
 * @brief Convert TSMetaContactList to array of TopStepContactModel
 * @chinese 将 TSMetaContactList 转为 TopStepContactModel 数组
 */
+ (NSArray<TopStepContactModel *> *)modelsWithTSMetaList:(nullable TSMetaContactList *)list;

/**
 * @brief Build TSMetaContactEmergencyList from TopStepContactModel array and enable flag
 * @chinese 由 TopStepContactModel 数组与启用标志构建 TSMetaContactEmergencyList
 */
+ (nullable TSMetaContactEmergencyList *)tsMetaEmergencyListWithModels:(nullable NSArray<TopStepContactModel *> *)models
                                                                enable:(BOOL)enable;

/**
 * @brief Convert TSMetaContactEmergencyList to array of TopStepContactModel
 * @chinese 将 TSMetaContactEmergencyList 转为 TopStepContactModel 数组
 */
+ (NSArray<TopStepContactModel *> *)modelsWithTSMetaEmergencyList:(nullable TSMetaContactEmergencyList *)list;
 ...
 */
+ (NSError *_Nullable)doesEmergencyContactsHasError:(nullable NSArray<TopStepContactModel *> *)emergencyContacts;
 ...
 */
+ (NSError *_Nullable)doesContactsHasError:(nullable NSArray<TopStepContactModel *> *)contacts;
 ...
 *       此方法直接修改联系人对象并返回同一数组。
 */
+ (NSArray<TopStepContactModel *> *)processContacts:(nullable NSArray<TopStepContactModel *> *)contacts;
