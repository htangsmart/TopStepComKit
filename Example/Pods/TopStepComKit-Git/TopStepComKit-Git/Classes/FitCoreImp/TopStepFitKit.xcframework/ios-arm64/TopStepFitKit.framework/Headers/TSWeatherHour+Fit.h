 ...
 *
 * @discussion 此方法将TSWeatherHour数组转换为FitCloud设备可识别的小时天气对象数组。
 * 转换内容包括：
 * - 天气类型
 * - 温度
 * - 风力等级
 ...
 */
+ (NSArray<FitCloudHourWeatherObject *> *)fitCloudHourArrayWithArray:(NSArray <TSWeatherHour *> *)hourWeatherArray;
 ...
 *
 * @discussion 此方法将单个TSWeatherHour转换为FitCloud设备可识别的小时天气对象。
 * 转换内容包括：
 ...
 */
+ (FitCloudHourWeatherObject *)fitCloudHourWeatherObjectFromHourWeatherModel:(TSWeatherHour *)hourWeatherModel;
