 ...
 * @chinese 检查设备是否支持配置压力监测时间段
 *
 * @return
 * [EN]: YES if the device supports configuring start/end time for stress monitoring, NO otherwise
 * [CN]: 如果设备支持配置压力监测开始/结束时间返回YES，否则返回NO
 *
 * @discussion
