...
@interface TSDatabasePool : NSObject
...
@interface NSObject (TSDatabasePoolDelegate)
...
- (BOOL)databasePool:(TSDatabasePool*)pool shouldAddDatabaseToPool:(TSDatabase*)database;
...
- (void)databasePool:(TSDatabasePool*)pool didAddDatabase:(TSDatabase*)database;
