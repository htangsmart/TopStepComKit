...
@interface TSErrorMsgDefines : NSObject
...
/**
 * @brief Data empty error
 * @chinese 数据为空错误
 */
FOUNDATION_EXPORT NSString *const kEMsgDataEmptyName;
...
/**
 * @brief User cancelled operation
 * @chinese 用户取消操作
 */
...
/**
 * @brief Peer removed pairing information
 * @chinese 配对信息被移除
 */
FOUNDATION_EXPORT NSString *const kEMsgPeerRemovedPairingInfoName;

/**
 * @brief Encryption timed out
 * @chinese 加密超时
 */
FOUNDATION_EXPORT NSString *const kEMsgEncryptionTimeoutName;

/**
 * @brief User ID mismatch
 * @chinese 用户ID不匹配
 */
FOUNDATION_EXPORT NSString *const kEMsgUserIdMismatchName;

/**
 * @brief User cancelled binding
 * @chinese 用户取消绑定
 */
FOUNDATION_EXPORT NSString *const kEMsgBindCancelledByUserName;

/**
 * @brief Bind timeout
 * @chinese 绑定超时
 */
FOUNDATION_EXPORT NSString *const kEMsgBindTimeoutName;

/**
 * @brief Classic Bluetooth not connected
 * @chinese 经典蓝牙未连接
 */
FOUNDATION_EXPORT NSString *const kEMsgClassicBluetoothNotConnectedName;

/**
 * @brief Low battery, cannot delete data
 * @chinese 电量不足无法删除数据
 */
FOUNDATION_EXPORT NSString *const kEMsgLowBatteryCannotDeleteDataName;

/**
 * @brief Device is performing factory reset
 * @chinese 设备正在恢复出厂
 */
FOUNDATION_EXPORT NSString *const kEMsgDeviceFactoryResettingName;

/**
 * @brief Factory reset required
 * @chinese 需要恢复出厂才能重新绑定
 */
FOUNDATION_EXPORT NSString *const kEMsgFactoryResetRequiredName;

/**
 * @brief Authentication failed with unknown reason
 * @chinese 认证失败未知原因
 */
FOUNDATION_EXPORT NSString *const kEMsgAuthenticationUnknownName;
...
/**
 * @brief Device has no space
 * @chinese 设备空间不足
 */
FOUNDATION_EXPORT NSString *const kEMsgHasNoSpaceName;
