...
@interface TSDatabaseQueue : NSObject
...
- (void)inDatabase:(__attribute__((noescape)) void (^)(TSDatabase *db))block;
...
- (void)inTransaction:(__attribute__((noescape)) void (^)(TSDatabase *db, BOOL *rollback))block;
...
- (void)inDeferredTransaction:(__attribute__((noescape)) void (^)(TSDatabase *db, BOOL *rollback))block;
...
- (void)inExclusiveTransaction:(__attribute__((noescape)) void (^)(TSDatabase *db, BOOL *rollback))block;
...
- (void)inImmediateTransaction:(__attribute__((noescape)) void (^)(TSDatabase *db, BOOL *rollback))block;
...
- (NSError * _Nullable)inSavePoint:(__attribute__((noescape)) void (^)(TSDatabase *db, BOOL *rollback))block;
