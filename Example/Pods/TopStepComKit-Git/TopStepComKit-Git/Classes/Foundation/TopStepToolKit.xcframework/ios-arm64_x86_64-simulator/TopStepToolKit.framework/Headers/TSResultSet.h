 ...
 */
typedef NS_ENUM(int, TSSqliteValueType) {
    TSSqliteValueTypeInteger = 1,
    TSSqliteValueTypeFloat   = 2,
    TSSqliteValueTypeText    = 3,
    TSSqliteValueTypeBlob    = 4,
    TSSqliteValueTypeNull    = 5
};
...
@interface TSResultSet : NSObject

@property (nonatomic, retain, nullable) TSDatabase *parentDB;
...
@property (atomic, retain, nullable) TSStatement *statement;
...
- (TSSqliteValueType)typeForColumn:(NSString*)columnName;
...
- (TSSqliteValueType)typeForColumnIndex:(int)columnIdx;
