...
/// @chinese 保存草稿元数据和音频，并将裸 PCM 封装为 WAV。
...
/// @brief Resolves local audio, creating a WAV copy for legacy PCM recordings when needed.
/// @chinese 解析本地音频，必要时为历史 PCM 录音创建 WAV 副本。
