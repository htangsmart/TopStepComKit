 ...
 *
 * @discussion 此方法将TSWeatherModel转换为FitCloud设备可识别的天气对象。
 * 转换内容包括：
 * - 城市信息（经纬度、城市名等）
 * - 当天天气（温度、天气类型、风力等）
 * - 未来7天天气预报
 ...
 * @return FitCloud天气对象
 */
+ (FitCloudWeatherObject *)fitCloudWeatherObjectFromWeatherModel:(TSWeatherModel *)weatherModel;
