...
@interface TSWeatherDayModel (Fit)
 ...
 *
 * @discussion 此方法将单个TSWeatherDayModel转换为FitCloud设备可识别的天气预报对象。
 * 转换内容包括：
 * - 白天天气类型
 * - 夜间天气类型
 * - 最高温度
 ...
 */
+ (FitCloudWeatherForecast *)fitCloudWeatherDayObjectFromWeatherModel:(TSWeatherDayModel *)weatherDayModel;
 ...
 *
 * @discussion 此方法将TSWeatherDayModel数组转换为FitCloud设备可识别的天气预报对象数组。
 * 主要用于转换未来7天的天气预报数据。
 * 转换内容与单个对象转换相同，包括：
 * - 天气类型（日间/夜间）
 * - 温度范围
 ...
 */
+ (NSArray<FitCloudWeatherForecast *> *)fitCloudWeatherDayArrayFromWeatherModels:(NSArray<TSWeatherDayModel *> *)weatherDayModels;
